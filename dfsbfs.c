...
#define MAX_SIZE 15
void dfs(int vertex, int visited[MAX_SIZE], int adjacencyMatrix[MAX_SIZE][MAX_SIZE], int vertexCount) 
{
...
void bfs(int startVertex, int visited[MAX_SIZE], int adjacencyMatrix[MAX_SIZE][MAX_SIZE], int vertexCount) 
{
